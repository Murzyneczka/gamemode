...
local randomQuestions = {
	{ // Questions about the Jail Break gamemode
		{question="Wer war der Ersteller der ersten Version von Jailbreak fuer Garrys Mod?",answer="excl"},
		{question="Was bedeutet LR?",answer="last request"},
		{question="Wer ist der sogenannte "Boss der Guards" und derjenige, der Befehle gibt?",answer="warden"},
	},
	{ // Questions about internet culture, games, etc...
		{question="Wer ist der Server Owner?",answer="Randos"},
		{question="Wen rettete Mario in allen Super Mario spielen?",answer="Prinzessin Peach"},
